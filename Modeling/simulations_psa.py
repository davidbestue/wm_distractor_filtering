...
separations = [3 for i in range(1)] + [3.5 for i in range(1)] + [4 for i in range(1)] + [5 for i in range(1)] +  [7 for i in range(1)] + [10 for i in range(1)] +  [12 for i in range(1)] +  [14 for i in range(1)] +  [18 for i in range(1)]
